...
from training_resnetBaseline import ClassifierTrainer
...
wandb.watch(models=(student_classifier))
...
# Define trainer
trainer = ClassifierTrainer(student_classifier, loss_fn, optimizer, device)
